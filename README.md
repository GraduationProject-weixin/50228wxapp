...
# 50228wxapp微信小程序的走失人员的报备平台设计ssm
...
此次开发这个基于微信小程序的走失人员的报备平台，不仅仅满足用户的需要，也能跟上时代的发展风向，从技术的角度还是用户的角度上进行开发都是很有意义的。
## 1.4 论文研究内容
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|xiansuomingcheng|String|线索名称|是|
|4|xiansuotupian|String|线索图片|是|
|5|xiansuoneirong|String|线索内容|是|
|6|faburiqi|date|发布日期|是|
|7|yonghuming|String|用户名|是|
|8|bumenzhanghao|String|部门账号|是|
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|pingjiabiaoti|String|评价标题|是|
|4|pingjiatupian|String|评价图片|是|
|5|bumenzhanghao|String|部门账号|是|
|6|fuzeren|String|负责人|是|
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|xingming|String|姓名|是|
|4|jinqizhaopian|String|近期照片|是|
|5|chuanzhexiguan|String|穿着习惯|是|
|6|changqudidian|String|常去地点|是|
|7|xingbie|String|性别|是|
|8|nianling|Integer|年龄|是|
|9|kouyin|String|口音|是|
|10|zhaohuizhuangtai|String|找回状态|是|
|11|zoushimiaoshu|String|走失描述|是|
|12|yonghuming|String|用户名|是|
|13|shouji|String|手机|是|
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|tixingbiaoti|String|提醒标题|是|
|4|jinqizhaopian|String|近期照片|是|
|5|tixingneirong|String|提醒内容|是|
|6|yonghuming|String|用户名|是|
|7|tixingshijian|datetime|提醒时间|是|
|8|userid|Integer|用户id|是|
9案件信息表
...
|8|nianling|Integer|年龄|是|
|9|kouyin|String|口音|是|
|10|anjianjindu|String|案件进度|是|
|11|zoushimiaoshu|String|走失描述|是|
|12|baobeishijian|datetime|报备时间|是|
|13|baobeididian|String|报备地点|是|
|14|yonghuming|String|用户名|是|
|15|shouji|String|手机|是|
|16|crossuserid|Integer|跨表用户id|是|
|17|crossrefid|Integer|跨表主键id|是|
